    ...
    function window:plinko_window(cfg)
        ...
        plinko_obj.config = {
            ...
            multipliers = {
                ...
                Medium = {10, 5, 2, 0.5, 0.2, 0.2, 0.5, 2, 5, 10},
