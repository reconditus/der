...
if not library.particle_cache.bg then library:InitParticles() end
    ...
    function window:page(cfg)
        ...
        local button_inline = library:create("Square", {Parent = button_holder, Visible = true, Transparency = 1, Thickness = 1, Filled = true, ZIndex = 13, Color = Color3.fromRGB(24, 24, 30), Size = UDim2.new(1,-2,1,-2),Position = UDim2.new(0,1,0,1)});
        local button_inline_gradient = library:create("Square", {Parent = button_inline, Visible = true, Transparency = 1, Thickness = 1, Filled = true, ZIndex = 13, Color = Color3.fromRGB(24, 24, 30), Size = UDim2.new(1,-2,1,-2),Position = UDim2.new(0,1,0,1)});
